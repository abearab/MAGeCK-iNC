pdf(file='iPSC_t10_vs_t0.pdf',width=4.5,height=4.5);
gstable=read.table('iPSC_t10_vs_t0.gene_summary.txt',header=T)
# 
#
# parameters
...
dev.off()
Sweave("iPSC_t10_vs_t0_summary.Rnw");
library(tools);

texi2dvi("iPSC_t10_vs_t0_summary.tex",pdf=TRUE);
